...
Note that the relevant mandatory keywords are *autogenerated* by [`create`](@ref),
*starting from the Julia datatype* and the *FITS object casting procedures*, 
[`cast_FITS`](@ref), [`cast_filnam`](@ref), [`cast_FITS_HDU`](@ref), 
[`cast_header`](@ref), [`cast_FITS_card`](@ref) and [`cast_FITS_data`](@ref).
# API
