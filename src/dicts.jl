...
dictDefinedKeywords = Dict(
    "        " => ("(blank)", _fits_standard, "commentary", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "none", "descriptive comment",
...
keyword fields may appear in a header."),
    "AUTHOR" => ("AUTHOR", _fits_standard, "bibliographic", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "author of the data",
...
bits that represent a data value (using a minus sign for floating point data)."),
    "BLANK" => ("BLANK", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "integer", "none", "value used for undefined array elements",
...
array values whose physical values are undefined."),
    "BLOCKED" => ("BLOCKED", _fits_standard, "production", "reserved", ("primary", "groups",), "logical", "none", "is physical blocksize a multiple of 2880?",
...
offset. The default value for this keyword is 1.0."),
    "BUNIT" => ("BUNIT", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "string", "none", "physical units of the array values",
...
The default value for this keyword is 0.0."),
    "CDELTn" => ("CDELTn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "none", "coordinate increment along axis",
...
These units must follow the prescriptions of section 5.3 of the FITS Standard."),
    "COMMENT" => ("COMMENT", _fits_standard, "commentary", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "none", "descriptive comment",
...
The value field shall contain a floating point number giving the rotation angle in degrees between axis n and the direction implied by the coordinate system defined by CTYPEn."),
    "CRPIXn" => ("CRPIXn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "none", "coordinate system reference pixel",
...
Use comments to indicate the location of the index point relative to the pixel."),
    "CRVALn" => ("CRVALn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "none", "coordinate system value at reference pixel",
...
Units must follow the prescriptions of section 5.3 of the FITS Standard."),
    "CTYPEn" => ("CTYPEn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "string", "none", "name of the coordinate axis",
        "The value field shall contain a character string, giving the name of the coordinate represented by axis n."),
    "DATAMAX" => ("DATAMAX", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "none", "maximum data value",
...
This number shall give the maximum valid physical value represented by the array, exclusive of any special values."),
    "DATAMIN" => ("DATAMIN", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "none", "minimum data value",
        "The value field shall always contain a floating point number, regardless of the value of BITPIX. 
This number shall give the minimum valid physical value represented by the array, exclusive of any special values."),
    "DATE" => ("DATE", _fits_standard, "production", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "date of file creation",
...
The new Y2K compliant date format is 'yyyy-mm-dd' or 'yyyy-mm-ddTHH:MM:SS[.sss]'."),
    "DATE-OBS" => ("DATE-OBS", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "date of the observation",
        "The date of the observation, in the format specified in the FITS Standard. 
The old date format was 'yy/mm/dd' and may be used only for dates from 1900 through 1999.  
The new Y2K compliant date format is 'yyyy-mm-dd' or 'yyyy-mm-ddTHH:MM:SS[.sss]'."),
    "END" => ("END", _fits_standard, "general", "mandatory", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "none", "marks the end of the header keywords",
        "This keyword has no associated value.  Columns 9-80 shall be filled with ASCII blanks."),
    "EPOCH" => ("EPOCH", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "real", "none", "equinox of celestial coordinate system",
...
Starting with Version 1, the Standard has deprecated the use of the EPOCH keyword and thus it shall not be used in FITS files created after the adoption of the standard; rather, the EQUINOX keyword shall be used."),
    "EQUINOX" => ("EQUINOX", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "real", "none", "equinox of celestial coordinate system",
        "The value field shall contain a floating point number giving the equinox in years for the celestial coordinate system in which positions are expressed."),
    "EXTEND" => ("EXTEND", _fits_standard, "general", "reserved", ("primary", "groups",), "logical", "none", "may the FITS file contain extensions?",
...
The presence of this keyword with the value T in the primary header does not require that extensions be present."),
    "EXTLEVEL" => ("EXTLEVEL", _fits_standard, "general", "reserved", ("extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      [1:] \nDEFAULT:    1", "hierarchical level of the extension",
...
This keyword is used to describe an extension and should not appear in the primary header."),
    "EXTNAME" => ("EXTNAME", _fits_standard, "general", "reserved", ("extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "name of the extension",
...
This keyword is used to describe an extension and should not appear in the primary header."),
    "EXTVER" => ("EXTVER", _fits_standard, "general", "reserved", ("extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      [1:] \nDEFAULT:    1", "version of the extension",
...
This keyword is used to describe an extension and should not appear in the primary header."),
    "GCOUNT" => ("GCOUNT", _fits_standard, "general", "mandatory", ("extension", "array", "image", "ASCII-table", "bintable"), "integer", "none", "group count",
...
In most other cases this keyword will have the value 1."),
    "GROUPS" => ("GROUPS", _fits_standard, "general", "mandatory", ("groups",), "logical", "none", "indicates random groups structure",
...
The value T associated with this keyword implies that random groups records are present."),
    "HISTORY" => ("HISTORY", _fits_standard, "commentary", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "none", "processing history of the data",
        "This keyword shall have no associated value; columns 9-80 may contain any ASCII text.  
...
Any number of HISTORY card images may appear in a header."),
    "INSTRUME" => ("INSTRUME", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "name of instrument",
...
If NAXIS is equal to 0, there should not be any NAXISn keywords."),
    "OBJECT" => ("OBJECT", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "name of observed object",
        "The value field shall contain a character string giving a name for the object observed."),
    "OBSERVER" => ("OBSERVER", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "observer who acquired the data",
        "The value field shall contain a character string identifying who acquired the data associated with the header."),
    "ORIGIN" => ("ORIGIN", _fits_standard, "production", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "organization responsible for the data",
    ...
    "PCOUNT" => ("PCOUNT", _fits_standard, "general", "mandatory", ("groups", "extension", "array", "image", "ASCII-table", "bintable"), "integer", "none", "parameter count",
        "The value field shall contain an integer that shall be used in any way appropriate to define the data structure, consistent with Eq.5.2 in the FITS Standard. 
...
The default value for this keyword is 1.0."),
    "PTYPEn" => ("PTYPEn", _fits_standard, "general", "reserved", ("groups",), "string", "none", "name of random groups parameter",
        "This keyword is reserved for use within the FITS Random Groups structure.  
...
The default value for this keyword is 0.0.  The transformation equation is as follows: physical_value = PZEROn + PSCALn * group_parameter_value."),
    "REFERENC" => ("REFERENC", _fits_standard, "bibliographic", "reserved",  ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "bibliographic reference",
    ...
    "SIMPLE" => ("SIMPLE", _fits_standard, "general", "mandatory", ("primary", "groups", "groups"), "logical", "none", "does file conform to the Standard?",
...
The first column of a row is numbered 1."),
    "TDIMn" => ("TDIMn", _fits_standard, "general", "reserved", ("bintable",), "string", "none", "dimensionality of the array ",
...
A proposed convention is described in Appendix B.2 of the FITS Standard in which the value string has the format '(l,m,n...)' where l, m, n,... are the dimensions of the array."),
    "TDISPn" => ("TDISPn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "string", "none", "display format",
...
The meaning of this keyword is not defined for fields of type P in the Standard but may be defined in conventions using such fields."),
    "TELESCOP" => ("TELESCOP", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "name of telescope",
...
The maximum permissible value is 999."),
    "TFORMn" => ("TFORMn", _fits_standard, "general", "mandatory", ("ASCII-table", "bintable"), "string", "none", "column data format",
    ...
    "THEAP" => ("THEAP", _fits_standard, "general", "reserved", ("bintable",), "integer", "none", "offset to starting data heap address",
...
A proposed application of this keyword is presented in Appendix B.1 of the FITS Standard."),
    "TNULLn" => ("TNULLn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "integer or string", "none", "value used to indicate undefined table element",
...
This keyword may not be used if the format of field n is A, L, or X."),
    "TTYPEn" => ("TTYPEn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "string", "none", "column name",
...
The use of identical names for different fields should be avoided."),
    "TUNITn" => ("TUNITn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "string", "none", "column units",
...
This keyword may not be used if the format of field n is A, L, or X."),
    "XTENSION" => ("XTENSION", _fits_standard, "general", "mandatory", ("extension", "array", "image", "ASCII-table", "bintable"), "string", "none", "marks beginning of new HDU",
