...
_fits_standard = "FITS Standard - version 4.0 - Appendix C"
...
dictErr = Dict(0 => nothing,
    ...
    5 => "incorrect DataType (Real type mandatory for array-type' HDUs)",
    ...
    21 => "NAXIS > 999 (array dimension exceeds maximum value 999)",
    22 => "NAXIS = 2 mandatory for table types",
    23 => "header contains illegal ASCII character (not ASCCI 32 - 126)",
    24 => "keyword contains illegal character.",
    25 => "HDU type not recognized",
    26 => "HDU type 'PRIMARY  ' expected",
    27 => "HDU type 'GROUPS   ' expected",
    28 => "HDU type 'IMAGE    ' expected",
    29 => "HDU type 'ARRAY    ' expected",
...
dictDefinedKeywords = Dict(
    "        " => ("(blank)", _fits_standard, "commentary", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "", "", "descriptive comment",
...
keyword fields may appear in a header."),
    "AUTHOR" => ("AUTHOR", _fits_standard, "bibliographic", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "author of the data",
...
from many sources."),
    "BITPIX" => ("BITPIX", _fits_standard, "general", "mandatory", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      -64,-32,8,16,32,64", "", "bits per data value",
...
bits that represent a data value (using a minus sign for floating point data)."),
    "BLANK" => ("BLANK", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "integer", "", "", "value used for undefined array elements",
...
array values whose physical values are undefined."),
    "BLOCKED" => ("BLOCKED", _fits_standard, "production", "reserved", ("primary", "groups",), "logical", "", "", "is physical blocksize a multiple of 2880?",
...
standard, the BLOCKED keyword has been deprecated."),
    "BSCALE" => ("BSCALE", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "1.0", "linear factor in scaling equation",
...
offset. The default value for this keyword is 1.0."),
    "BUNIT" => ("BUNIT", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "string", "", "", "physical units of the array values",
...
recommended units (with the units, if specified, given as 'deg')."),
    "BZERO" => ("BZERO", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "0.0", "zero point in scaling equation",
...
The default value for this keyword is 0.0."),
    "CDELTn" => ("CDELTn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "", "coordinate increment along axis",
        "The value field shall contain a floating point number giving the partial derivative of the coordinate specified by the CTYPEn keywords with respect to the pixel index, 
evaluated at the reference point CRPIXn, in units of the coordinate specified by  the CTYPEn keyword.  
These units must follow the prescriptions of section 5.3 of the FITS Standard."),
    "COMMENT" => ("COMMENT", _fits_standard, "commentary", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "", "", "descriptive comment",
...
Any number of COMMENT card images may appear in a header."),
    "CROTAn" => ("CROTAn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "UNITS:      degrees", "", "coordinate system rotation angle",
...
The value field shall contain a floating point number giving the rotation angle in degrees between axis n and the direction implied by the coordinate system defined by CTYPEn."),
    "CRPIXn" => ("CRPIXn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "", "coordinate system reference pixel",
...
Use comments to indicate the location of the index point relative to the pixel."),
    "CRVALn" => ("CRVALn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "", "coordinate system value at reference pixel",
...
Units must follow the prescriptions of section 5.3 of the FITS Standard."),
    "CTYPEn" => ("CTYPEn", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "string", "", "", "name of the coordinate axis",
        "The value field shall contain a character string, giving the name of the coordinate represented by axis n."),
    "DATAMAX" => ("DATAMAX", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "", "maximum data value",
...
This number shall give the maximum valid physical value represented by the array, exclusive of any special values."),
    "DATAMIN" => ("DATAMIN", _fits_standard, "general", "reserved", ("primary", "groups", "image"), "real", "", "", "minimum data value",
        "The value field shall always contain a floating point number, regardless of the value of BITPIX. 
This number shall give the minimum valid physical value represented by the array, exclusive of any special values."),
    "DATE" => ("DATE", _fits_standard, "production", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "date of file creation",
...
The new Y2K compliant date format is 'yyyy-mm-dd' or 'yyyy-mm-ddTHH:MM:SS[.sss]'."),
    "DATE-OBS" => ("DATE-OBS", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "date of the observation",
        "The date of the observation, in the format specified in the FITS Standard. 
The old date format was 'yy/mm/dd' and may be used only for dates from 1900 through 1999.  
The new Y2K compliant date format is 'yyyy-mm-dd' or 'yyyy-mm-ddTHH:MM:SS[.sss]'."),
    "END" => ("END", _fits_standard, "general", "mandatory", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "", "", "marks the end of the header keywords",
        "This keyword has no associated value.  Columns 9-80 shall be filled with ASCII blanks."),
    "EPOCH" => ("EPOCH", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "real", "", "", "equinox of celestial coordinate system",
...
Starting with Version 1, the Standard has deprecated the use of the EPOCH keyword and thus it shall not be used in FITS files created after the adoption of the standard; rather, the EQUINOX keyword shall be used."),
    "EQUINOX" => ("EQUINOX", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "real", "", "", "equinox of celestial coordinate system",
        "The value field shall contain a floating point number giving the equinox in years for the celestial coordinate system in which positions are expressed."),
    "EXTEND" => ("EXTEND", _fits_standard, "general", "reserved", ("primary", "groups",), "logical", "", "", "may the FITS file contain extensions?",
        "If the FITS file may contain extensions, a card image with the keyword EXTEND and the value field containing the logical value T 
must appear in the primary header immediately after the last NAXISn card image, or, if NAXIS=0, the NAXIS card image.
The presence of this keyword with the value T in the primary header does not require that extensions be present."),
    "EXTLEVEL" => ("EXTLEVEL", _fits_standard, "general", "reserved", ("extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      [1:]", "1", "hierarchical level of the extension",
...
This keyword is used to describe an extension and should not appear in the primary header."),
    "EXTNAME" => ("EXTNAME", _fits_standard, "general", "reserved", ("extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "name of the extension",
...
This keyword is used to describe an extension and should not appear in the primary header."),
    "EXTVER" => ("EXTVER", _fits_standard, "general", "reserved", ("extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      [1:]", "1", "version of the extension",
...
This keyword is used to describe an extension and should not appear in the primary header."),
    "GCOUNT" => ("GCOUNT", _fits_standard, "general", "mandatory", ("extension", "array", "image", "ASCII-table", "bintable"), "integer", "", "", "group count",
...
In most other cases this keyword will have the value 1."),
    "GROUPS" => ("GROUPS", _fits_standard, "general", "mandatory", ("groups",), "logical", "", "", "indicates random groups structure",
...
The value T associated with this keyword implies that random groups records are present."),
    "HISTORY" => ("HISTORY", _fits_standard, "commentary", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "none", "", "", "processing history of the data",
        "This keyword shall have no associated value; columns 9-80 may contain any ASCII text.  
...
Any number of HISTORY card images may appear in a header."),
    "INSTRUME" => ("INSTRUME", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "name of instrument",
    ...
    "NAXIS" => ("NAXIS", _fits_standard, "general", "mandatory", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      [0:999]", "", "number of axes",
...
In the context of FITS 'TABLE' or 'BINTABLE' extensions, the value of NAXIS is always 2."),
    "NAXISn" => ("NAXISn", _fits_standard, "general", "mandatory", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "integer", "RANGE:      [0:]", "", "size of the axis",
        "The value field of this indexed keyword shall contain a non-negative integer, 
...
If NAXIS is equal to 0, there should not be any NAXISn keywords."),
    "OBJECT" => ("OBJECT", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "name of observed object",
        "The value field shall contain a character string giving a name for the object observed."),
    "OBSERVER" => ("OBSERVER", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "observer who acquired the data",
        "The value field shall contain a character string identifying who acquired the data associated with the header."),
    "ORIGIN" => ("ORIGIN", _fits_standard, "production", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "organization responsible for the data",
    ...
    "PCOUNT" => ("PCOUNT", _fits_standard, "general", "mandatory", ("groups", "extension", "array", "image", "ASCII-table", "bintable"), "integer", "", "", "parameter count",
        "The value field shall contain an integer that shall be used in any way appropriate to define the data structure, consistent with Eq.5.2 in the FITS Standard. 
...
In most other cases its value will be zero."),
    "PSCALn" => ("PSCALn", _fits_standard, "general", "reserved", ("groups",), "real", "", "1.0", "parameter scaling factor",
        "This keyword is reserved for use within the FITS Random Groups structure. 
This keyword shall be used, along with the PZEROn keyword, when the nth FITS group parameter value 
is not the true physical value, to transform the group parameter value to the true physical values it represents, 
using the equation, physical_value = PZEROn + PSCALn * group_parameter_value. The value field shall contain a floating point number 
representing the coefficient of the linear term, the scaling factor between true values and group parameter values at zero offset.  
The default value for this keyword is 1.0."),
    "PTYPEn" => ("PTYPEn", _fits_standard, "general", "reserved", ("groups",), "string", "", "", "name of random groups parameter",
        "This keyword is reserved for use within the FITS Random Groups structure.  
The value field shall contain a character string giving the name of parameter n.  If the PTYPEn keywords for more than one value of n 
have the same associated name in the value field, then the data value for the parameter of that name is to be obtained by adding the derived data values of the corresponding parameters. 
...
for example, by summing two 16-bit values with the first scaled relative to the other such that the sum forms a number of up to 32-bit precision."),
    "PZEROn" => ("PZEROn", _fits_standard, "general", "reserved", ("groups",), "real", "", "0.0", "parameter scaling zero point",
        "This keyword is reserved for use within the FITS Random Groups structure. 
...
The default value for this keyword is 0.0.  The transformation equation is as follows: physical_value = PZEROn + PSCALn * group_parameter_value."),
    "REFERENC" => ("REFERENC", _fits_standard, "bibliographic", "reserved",  ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "bibliographic reference",
    ...
    "SIMPLE" => ("SIMPLE", _fits_standard, "general", "mandatory", ("primary", "groups", "groups"), "logical", "", "", "does file conform to the Standard?",
...
This keyword is mandatory for the primary header and is not permitted in extension headers. A value of F signifies that the file does not conform to this standard."),
    "TBCOLn" => ("TBCOLn", _fits_standard, "general", "mandatory", ("ASCII-table",), "integer", "RANGE:      [1:]", "", "begining column number",
...
The first column of a row is numbered 1."),
    "TDIMn" => ("TDIMn", _fits_standard, "general", "reserved", ("bintable",), "string", "", "", "dimensionality of the array ",
        "The value field of this indexed keyword shall contain a character string describing how to 
interpret the contents of field n as a multidimensional array, providing the number of dimensions and the length along each axis.
The form of the value is not further specified by the Standard.  A proposed convention is described in Appendix B.2 of the FITS Standard 
in which the value string has the format '(l,m,n...)' where l, m, n,... are the dimensions of the array."),
    "TDISPn" => ("TDISPn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "string", "", "", "display format",
...
The format codes must be specified in upper case. If the Bw.m, Ow.m, and Zw.m formats are not readily available to the reader, 
the Iw.m display format may be used instead, and if the ENw.d and ESw.d formats are not available, Ew.d may be used.  
The meaning of this keyword is not defined for fields of type P in the Standard but may be defined in conventions using such fields."),
    "TELESCOP" => ("TELESCOP", _fits_standard, "observation", "reserved", ("primary", "groups", "extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "name of telescope",
    ...
    "TFIELDS" => ("TFIELDS", _fits_standard, "general", "mandatory", ("ASCII-table", "bintable"), "integer", "RANGE:      [0:999]", "", "number of columns in the table",
...
The maximum permissible value is 999."),
    "TFORMn" => ("TFORMn", _fits_standard, "general", "mandatory", ("ASCII-table", "bintable"), "string", "", "", "column data format",
    ...
    "THEAP" => ("THEAP", _fits_standard, "general", "reserved", ("bintable",), "integer", "", "", "offset to starting data heap address",
...
A proposed application of this keyword is presented in Appendix B.1 of the FITS Standard."),
    "TNULLn" => ("TNULLn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "integer or string", "", "", "value used to indicate undefined table element",
...
The keyword may not be used in 'BINTABLE' extensions if field n is of any other data type."),
    "TSCALn" => ("TSCALn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "real", "", "1.0", "linear data scaling factor",
...
physical_value = TZEROn + TSCALn * field_value, which must be used to compute the true physical value of the field, or, 
in the case of the complex data types C and M, of the real part of the field with the imaginary part of the scaling factor set to zero.
The default value for this keyword is 1.0.  This keyword may not be used if the format of field n is A, L, or X."),
    "TTYPEn" => ("TTYPEn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "string", "", "", "column name",
...
The use of identical names for different fields should be avoided."),
    "TUNITn" => ("TUNITn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "string", "", "", "column units",
...
For angular measurements given as floating point values and specified with reserved keywords, degrees are the recommended units (with the units, if specified, given as 'deg')."),
    "TZEROn" => ("TZEROn", _fits_standard, "general", "reserved", ("ASCII-table", "bintable"), "real", "", "0.0", "column scaling zero point",
...
This keyword may not be used if the format of field n is A, L, or X."),
    "XTENSION" => ("XTENSION", _fits_standard, "general", "mandatory", ("extension", "array", "image", "ASCII-table", "bintable"), "string", "", "", "marks beginning of new HDU",
