...
function _write1_header(hdu::FITS1_HDU)
...
function _write1_data(hdu::FITS1_HDU)

    hdutype = hdu.dataobject.hdutype

    hdutype == "PRIMARY" && return _write1_IMAGE_data(hdu)
    hdutype == "IMAGE" && return _write1_IMAGE_data(hdu)
    hdutype == "TABLE" && return _write1_TABLE_data(hdu)
    hdutype == "BINTABLE" && return _write1_BINTABLE_data(hdu)
...
function _write1_IMAGE_data(hdu::FITS1_HDU)
...
function _write1_TABLE_data(hdu::FITS1_HDU)
