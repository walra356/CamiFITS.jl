...
A Julia package for reading and writing files under the FITS format 
...
Within CamiFix only the basic FITS functionality is implemented for users not requiring celestal coordinates. The user can create, read and extend .fits files as well as create, edit and delete user-defined metainformation.
